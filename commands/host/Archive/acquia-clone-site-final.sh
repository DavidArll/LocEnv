...
function verify_sites_php && register_local_site "${DB_NAME}-${ENVIRONMENT_TYPE}.ddev.site" "$DB_NAME"() {
...
function finalize_process() {
    ...
    verify_sites_php && register_local_site "${DB_NAME}-${ENVIRONMENT_TYPE}.ddev.site" "$DB_NAME"
